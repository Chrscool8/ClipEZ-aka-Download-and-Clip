...
QT_MOC_LITERAL(11, 146, 16), // "choose_directory"
QT_MOC_LITERAL(12, 163, 18), // "processStateChange"
QT_MOC_LITERAL(13, 182, 11), // "std::string"
QT_MOC_LITERAL(14, 194, 22), // "QProcess::ProcessState"
QT_MOC_LITERAL(15, 217, 8), // "newState"
QT_MOC_LITERAL(16, 226, 3) // "tag"
    ...
    "choose_directory\0processStateChange\0"
...
static const uint qt_meta_data_Download_and_Clip[] = {
 ...
 // slots: parameters
    ...
    QMetaType::Void,
    QMetaType::Void,
    QMetaType::Void, 0x80000000 | 13, 0x80000000 | 14, 0x80000000 | 13,    2,   15,   16,
...
void Download_and_Clip::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 8: _t->choose_directory(); break;
        case 9: _t->processStateChange((*reinterpret_cast< std::string(*)>(_a[1])),(*reinterpret_cast< QProcess::ProcessState(*)>(_a[2])),(*reinterpret_cast< std::string(*)>(_a[3]))); break;
        default: ;
        }
    }
}
